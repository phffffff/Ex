	     ...
	     <?php while ( $products->have_posts() ) : $products->the_post(); ?>
          ...
          if($style == 'default'){
	            	...
	            	<div class="<?php echo implode(' ', $classes_col); ?>" <?php echo $animate;?>>
						...
						<div class="time-kh"><p>Tháng <?php echo get_post_meta(get_the_ID(),'wpcf-cac-thang-co-tour',true); ?></p></div>
							...
							<div class="box-text <?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
								<?php
									...
									echo '</div>';
								?>	
									<div class="row box-add">
									<div class="large-6 box-date">
									<p><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo get_post_meta(get_the_ID(),'wpcf-ngay-dem',true); ?></p>
									<p><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo date('d-m-Y',get_post_meta(get_the_ID(),'wpcf-ngay-tour',true)); ?></p>
									
									</div>
									<div class="large-6 box-price">
								<?php
									...
									echo '<p class="line-through"><i class="fa fa-usd" aria-hidden="true"></i> '.$giagoc_format.' VNĐ</p>';
									echo '<p class="hotsale">'.$giasale_format.' VNĐ</p>';
									echo '</div>
									</div>
									';

tra<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div id ="header">
    ...
    <div class ="container">
    	...
    	<div class="search">
        	<form class="searchform" action="../index/search.php" method="get" style="
    margin-bottom: 0px;
">
	...
	<div class="navigation">
    	<div class="blackRum">
            ...
            <span class="tittleRum">
            	<?php 
					$mypham_query ="SELECT * FROM menu where name_menu=N'Trang Điểm'";
    ...
    <section class="content_ld">
        ...
        <aside class="filter" id="filter_cate">
        	<div class="filter_v">
                ...
                <?php
					...
					echo "<li><a href='#' class='tittlea'>CHĂM SÓC BODY</a>
									<ul class='menu_in_left'>";
									while($menu_left2_items = mysqli_fetch_array($menu_left2_res))
									{
										echo"<li><a href='#'>".$menu_left2_items['name_sub']." </a></li>";
									}
					echo "
									</ul>
						</li>";
        ...
        <aside class="product_l">
        	<div class="product_boder">
            	<?php 
								// tong so records
								$result =mysqli_query($conn,"select count(id_product) as total from product where parent_product=N'Trang Điểm'");
								...
								$result = mysqli_query($conn,"SELECT * FROM product where parent_product =N'Trang Điểm' LIMIT $start, $litmit");
            ...
            <div class="phan_trang">
            	<?php
					...
					{
						echo "<a href='trang-diem.php?page=".($current_page - 1)."'>
								<b class='prev'></b>
							</a>";
					}
					...
					for($i = 1;$i <= $total_page;$i++)
					{
						...
						echo "<li><a href='trang-diem.php?page=".$i."'>".$i."</a></li>";
...
<div class="footer">
    ...
    <div class="container">
        ...
        <div class="link call"> Tổng đài tư vấn bán hàng (7:30 - 22:00) hằng ngày<br/>
        	<span class="tongtaituphone">0981528588 (Doanh)</span><!--end tongdaituphone--><br/>
            Điện thoại
            <span class="tongtaituphone">0981528588 (Doanh)</span><!--end tongdaituphone--><br/>
            Giải quyết khiếu nại từ (9:00 - 17:00) hằng ngày
            <span class="tongtaituphone">0981528588 (Doanh)</span><!--end tongdaituphone-->
        </div><!--end link call-->
    </div><!--end container footer-->
    <div class="clear"></div><!--end clear-->
    <div class="footerAdd"> © 2022. Công Ty Mỹ Phẩm Skina Beauty<br/>

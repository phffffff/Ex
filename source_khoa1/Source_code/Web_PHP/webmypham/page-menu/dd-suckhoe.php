	...
	<div class="navigation">
    	<div class="blackRum">
            ...
            <span class="tittleRum">
            	<?php 
					$mypham_query ="SELECT * FROM menu where name_menu=N'Dinh Dưỡng - Sức Khỏe'";
    ...
    <section class="content_ld">
        ...
        <aside class="filter" id="filter_cate">
        	<div class="filter_v">
                ...
                <?php
					...
					echo "<li><a href='#' class='tittlea'>CHĂM SÓC DA MẶT</a>
									<ul class='menu_in_left'>";
									while($menu_left_items = mysqli_fetch_array($menu_left_res))
									{
										echo"<li><a href='#'>".$menu_left_items['name_sub']." </a></li>";
									}
					echo "
									</ul>
						</li>";
        ...
        <aside class="product_l">
        	<div class="product_boder">
            	<?php 
								// tong so records
								$result =mysqli_query($conn,"select count(id_product) as total from product where parent_product=N'Dinh Dưỡng - Sức Khỏe'");
								...
								$result = mysqli_query($conn,"SELECT * FROM product where parent_product =N'Dinh Dưỡng - Sức Khỏe' LIMIT $start, $litmit");
            	...
            	<?php
					...
					{
						echo "<a href='dd-suckhoe.php?page=".($current_page - 1)."'>
								<b class='prev'></b>
							</a>";
					}
					...
					for($i = 1;$i <= $total_page;$i++)
					{
						...
						echo "<li><a href='dd-suckhoe.php?page=".$i."'>".$i."</a></li>";

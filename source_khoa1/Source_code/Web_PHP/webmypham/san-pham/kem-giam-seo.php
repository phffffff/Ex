	...
	<div class="navigation">
    	<div class="blackRum">
            ...
            <span class="tittleRum">
            	<?php 
					$mypham_query ="SELECT * FROM submenu where name_sub=N'Kem Giúp Giảm Sẹo'";
					$mypham_res = mysqli_query($conn,$mypham_query) or die("Cannot select table!");
					while ($mypham_items = mysqli_fetch_array($mypham_res))
					{
						echo'
    ...
    <section class="content_ld">
        ...
        <aside class="product_l">
        	<div class="product_boder">
            	<?php 
								// tong so records
								$result =mysqli_query($conn,"select count(id_product) as total from product where useful_product=N'kem giảm sẹo'");
								...
								$result = mysqli_query($conn,"SELECT * FROM product where useful_product=N'kem giảm sẹo' LIMIT $start, $litmit");
            ...
            <div class="phan_trang">
            	<?php
					...
					{
						echo "<a href='kem-giam-seo.php?page=".($current_page - 1)."'>
								<b class='prev'></b>
							</a>";
					}
					...
					for($i = 1;$i <= $total_page;$i++)
					{
						...
						echo "<li><a href='kem-giam-seo.php?page=".$i."'>".$i."</a></li>";

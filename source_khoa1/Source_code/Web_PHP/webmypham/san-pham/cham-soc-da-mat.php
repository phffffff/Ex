    ...
    <section class="content_ld">
        ...
        <aside class="product_l">
        	<div class="product_boder">
            	<?php 
								// tong so records
								$result =mysqli_query($conn,"select count(id_product) as total from product where type_product=N'chăm sóc da mặt'");
								...
								$result = mysqli_query($conn,"SELECT * FROM product where type_product=N'chăm sóc da mặt' LIMIT $start, $litmit");
